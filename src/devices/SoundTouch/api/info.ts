import { Component, componentFromElement } from './component.js';
import { NetworkInfo, networkInfoFromElement } from './network-info.js';
...
export function infoFromElement(element: XMLElement): Info | undefined {
  if (
    !element.hasAttributes(['deviceID']) ||
